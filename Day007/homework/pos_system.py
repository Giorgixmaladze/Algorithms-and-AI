def pos_system(num,current_pos,target_pos):
...
current_pos = int(input("Enter the number's current position: "))
target_pos = int(input("Enter the target position: "))


print(pos_system(num,current_pos,target_pos))
